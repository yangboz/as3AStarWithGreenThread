...
//
//--------------------------------------------------------------------------
import com.lookbackon.ds.aStar.GTAStarNode;
...
public class AStarNodeBoard implements IAStar {
	...
	//
	public function get endNode():GTAStarNode {
		return _endNode;
	}

	//
	public function get startNode():GTAStarNode {
		return _startNode;
	}
	...
	public function AStarNodeBoard(column:int, row:int) {
		...
		for (var i:int = 0; i < this.column; i++) {
			...
			for (var j:int = 0; j < this.row; j++) {
				_nodes[i][j] = new GTAStarNode(i, j);
			}
		}
	}
	 ...
	 * @param y The y coord.
	 */
	public function getNode(x:int, y:int):GTAStarNode {
		return _nodes[x][y] as GTAStarNode;
	}
	...
	public function setEndNode(x:int, y:int):void {
		_endNode = _nodes[x][y] as GTAStarNode;
	}
	...
	public function setStartNode(x:int, y:int):void {
		_startNode = _nodes[x][y] as GTAStarNode;
	}
